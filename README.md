...
<body>
  ...
  <section class="py-5">
    <div class="container">
      ...
      <div class="row g-4">
        <div class="col-md-4">
          <div class="card">
            <img src="navigation.jpg" class="card-img-top" alt="Shot 1">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="content.jpg" class="card-img-top" alt="Shot 2">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="ter.jpg" class="card-img-top" alt="Shot 3">
            <div class="card-body">
  ...
  <footer class="bg-dark text-white text-center py-3">
    <div class="container">
      <p class="mb-0">Designed by NARENDRA KRISHNAN KUMAR KS</p>
    </div>
  </footer>
...
```
# OUTPUT:
![500759982-40beb492-d5d9-4f94-87ed-a596cee60447](https://github.com/user-attachments/assets/47f3e4c1-f749-4f3d-a1c0-d22e1128b5fa)
